-- Evade Hack Mobile | By Chiriku | Fast TP Egg + Avoid Bot + Auto Revive
...
toggle.Image = "rbxassetid://119198835819797" -- Icon mới
			...
			for _, bot in ipairs(workspace:GetDescendants()) do
				if bot:IsA("Model") and bot:FindFirstChild("HumanoidRootPart") and bot.Name ~= plr.Name then
					...
					if dist < 30 then
						...
						targetPos = Vector3.new(targetPos.X, 10, targetPos.Z) -- giữ trong map
